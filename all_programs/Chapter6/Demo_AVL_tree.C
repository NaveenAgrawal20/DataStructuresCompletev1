...
main()
{
	...
	root = insert(root,16);display(root,0); printf("\n\n\n");
	root = insert(root,23);display(root,0); printf("\n\n\n");
	root = insert(root,9);display(root,0); printf("\n\n\n");
	root = insert(root,163);display(root,0); printf("\n\n\n");
	root = insert(root,64);display(root,0); printf("\n\n\n");
	root = insert(root,29);display(root,0); printf("\n\n\n");
	root = insert(root,73);display(root,0); printf("\n\n\n");
	root = insert(root,83);display(root,0); printf("\n\n\n");
	root = insert(root,90);display(root,0); printf("\n\n\n");
	root = insert(root,96);display(root,0); printf("\n\n\n");
